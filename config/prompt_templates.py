class PromptTemplates:
    ...
    def load_templates(self, dataset, model):
        ...
        if dataset in ["nfqa","nfqa_rag"]:
            self.zero_shot_system_role = "You are a helpful membrane science assistant."
        ...
        elif dataset in ['nfqa_open', "nfqa_open_rag"]:
            self.zero_shot_system_role = "You are a helpful membrane science assistant."
            self.zero_shot_ao_trigger = "The answer is"
            self.zero_shot_cot_trigger = "After your thought, therefore, the answer is"
        else:
        ...
        if model == "deepseek-reasoner":
            ...
            self.zero_shot_ao_system_role = "You are a helpful membrane science assistant."

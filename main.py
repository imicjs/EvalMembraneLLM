...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", default='google/gemini-2.0-flash-001', type=str)
    parser.add_argument("--dataset", default='nfqa_rag', type=str)
    parser.add_argument("--task", default="", type=str)
    parser.add_argument("--output-dir", default='nfqa_rag', type=str)
